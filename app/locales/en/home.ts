const value = {
  meta: {
    ...
    "og:title": "Miraibo Go - Pal-like open-world survival game",
  ...
  content: {
    hero: {
      heading: "Miraibo Go - Pal-like open-world survival game",
      parameter:
        "Dive into the world of Miraibo Go, embark on an epic adventure, uncover hidden treasures, conquer the Miraibo world, battle fierce opponents.",
      "get-it-on": "Get it on",
      "sub-param":
        "Miraibo Go is free to play on mobile devices and PC and offers cross-platform gaming support.",
    },
    features: {
      heading: "What awaits you in Miraibo Go",
      parameter:
        'Fight, farm, build and work alongside mysterious creatures called "Mira" in this completely new multiplayer, open world survival and crafting game!',
      list: [
        {
    ...
    dives: {
      heading: "Dive into the world of Miraibo Go",
      parameter:
        "Discover a new kind of Pokémon experience with Miraibo Go! Capture wild Mira, and challenge powerful bosses in this innovative open-world game.",
      list: [
        {
          title: "Tame the Miras",
          description: "Hundreds of Miras await you!",
        },
        {
          title: "Build without limits",
    ...
    "creator-program": {
      heading: "Miraibo Go Creator Program",
      parameter:
        "The Miraibo Go Creator Program is a unique community of content creators focused on producing engaging and high-quality content for the dynamic world of Miraibo!",
      "learn-more": "Learn More for Miraibo Go Creator Program",
      "sub-param":
        "Whether you're a Youtuber, Streamer or Blogger, we want to build the world of Miraibo Go with you.",
    },
    "social-proof": {
      heading: "Miraibo Go Loved by people worldwide",
      parameter:
        "Join the Miraibo Go craze and explore, fight, build and work with Mira!",
    },
    faqs: {
